...
@dataclass
class ModelParams:
    model_name: str = 'mega_unet_ddpm_74M'
    im_channels: int = 3
    im_size: tuple = (64, 64)  # Height, Width
    down_channels: list = (32, 64, 128, 256, 512)
    mid_channels: list = (512, 512, 256)
    down_sample: list = (True, True, True, False)
    ...
    down_apply_attention: list = (True, True, True, True, True)
    mid_apply_attention: list = (True, True, True)
    up_apply_attention: list = (True, True, True, True, True)
...
class TrainConfig:
    num_epochs: int = 20
    batch_size: int = 2  # Adjusted for GPU memory
    num_workers: int = 0
