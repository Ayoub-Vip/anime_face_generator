...
@dataclass
class ModelParams:
    model_name: str = 'simple_unet_ddpm_49M'
    im_channels: int = 3
    ...
    down_apply_attention: list = (True, True, True)
    mid_apply_attention: list = (True, True)
    up_apply_attention: list = (True, True, True)
...
class TrainConfig:
    num_epochs: int = 20
    batch_size: int = 3  # Adjusted for GPU memory
    num_workers: int = 4
